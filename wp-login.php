...
<link rel="stylesheet" href="./wp-content/themes/wp_bootstrap5_theme/assets/css/bootstrap.min.css" >
...
.login{
	...
	<div class="homepage-heading">
        ...
        <div class="login">
        <a role="button" class="btns" href="/easyM/register/">Register</a>          
        </div>
    </div>
...
adnd congestion -along with full 
visibility
            </p>
          </div>
          <!-- Grid column -->
